  ...
  return (
    <main>
      <div className="text-center text-white hero-section">
        ...
        <p className="text-gray-600 container"> Lorem Ipsum is simply dummy text of the printing and typesettivpnDatang industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
        </p>
      </div>
